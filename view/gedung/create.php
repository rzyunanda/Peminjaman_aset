...
?>
<?php startblock('title') ?> Create Kendaraan <?php endblock() ?>
...
<div class="card">
    <div class="card-block">
        <form id="second" action="/peminjaman-aset/controller/kendaraanController.php?aksi=create" method="post" novalidate>
